 ...
 * lived installation cannot grow without bound. This is the Android twin of the identical class in
 * `jvmMain`; the directory comes from the app's private storage.
 */
