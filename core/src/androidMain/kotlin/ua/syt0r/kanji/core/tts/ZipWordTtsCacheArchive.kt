...
/**
 * [WordTtsCacheArchive] backed by a zip file in the app's external files directory, which the user
 * can reach over USB (`Android/data/<package>/files/`). The desktop twin lives in `jvmMain`.
 */
